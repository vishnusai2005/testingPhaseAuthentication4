 ...
 `testing.js` file and database file `testing.db` with a table `todotesting`.

Write APIs to perform operations on the table `todotesting`, with the following columns,
